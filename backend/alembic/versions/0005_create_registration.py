...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'REJECTED', 'ACCEPTED', name='registration_status'), nullable=False),
    sa.Column('hackathon_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['hackathon_id'], ['hackathons.id'], ondelete='CASCADE'),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('registration_id', 'question_id', name='uq_answer_application_question')
    )
