...
class ErrorCode(StrEnum):
    ...
    CO_ORGANIZER_SEARCH_RATE_LIMIT_EXCEEDED = "CO_ORGANIZER_SEARCH_RATE_LIMIT_EXCEEDED"
    ...
    REGISTRATION_STATUS_CHANGE_LOCKED = "REGISTRATION_STATUS_CHANGE_LOCKED"
    ...
    TASKS_NOT_RELEASED = "TASKS_NOT_RELEASED"
    INVALID_TASK_VISIBILITY_DATE = "INVALID_TASK_VISIBILITY_DATE"
    TEAM_REQUIRED_FOR_SUBMISSION = "TEAM_REQUIRED_FOR_SUBMISSION"
    TASK_SUBMISSION_CLOSED = "TASK_SUBMISSION_CLOSED"
