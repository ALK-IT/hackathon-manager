...
class ErrorCode(StrEnum):
    ...
    REGISTRATION_WITHDRAWAL_LOCKED = "REGISTRATION_WITHDRAWAL_LOCKED"
    ...
    TASK_SUBMISSION_NOT_FOUND = "TASK_SUBMISSION_NOT_FOUND"
    TASK_EVALUATION_NOT_OPEN = "TASK_EVALUATION_NOT_OPEN"

    ATTENDANCE_ERROR = "ATTENDANCE_ERROR"
    CHECK_IN_NOT_ALLOWED = "CHECK_IN_NOT_ALLOWED"
    INVALID_CHECK_IN_TOKEN = "INVALID_CHECK_IN_TOKEN"
    HACKATHON_NOT_IN_PROGRESS = "HACKATHON_NOT_IN_PROGRESS"
    CHECK_IN_SESSION_CONFLICT = "CHECK_IN_SESSION_CONFLICT"
    ...
    RESOURCE_HAS_ACTIVE_ASSIGNMENTS = "RESOURCE_HAS_ACTIVE_ASSIGNMENTS"
