...
- **Backend:** nowe moduły `models/user.py`, `schemas/user.py`, `repositories/user_repository.py`, `services/user_service.py`, `routers/auth.py` i `security.py`; router uwierzytelniania jest podpięty do aplikacji FastAPI przez zbiorczy `api_router`.
